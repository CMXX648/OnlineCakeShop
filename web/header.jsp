...
<div class="navbar-header">
    ...
    <h1 class="navbar-brand"><a href="/index">广州蛋糕店</a></h1>
</div>
<!--navbar-header-->
...
<!-- 用<c:choose>标签来判断用户是否登录 -->
    <c:choose><c:when test="${empty user }">
        ...
        <li class="hidden"><a href="/user_register.jsp">注册</a></li>
        <li class="hidden"><a href="/user_login.jsp">登录</a></li>
